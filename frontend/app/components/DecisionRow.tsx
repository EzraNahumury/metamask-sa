  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className={cn(
          "group relative w-full text-left rounded-xl border border-white/[0.04] bg-white/[0.012] hover:border-white/10 transition-colors overflow-hidden",
              ...
              <div className="px-4 py-4 ml-[58px] flex flex-col gap-3 bg-white/[0.01]">
                ...
                {d.txHash ? (
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="self-start inline-flex items-center gap-1.5 text-[11px] font-mono text-emerald-300 hover:text-emerald-200"
                  >
                    inspect on basescan
...
function Block({
  ...
  return (
    <div>
      <div className="text-[10px] uppercase tracking-[0.22em] text-zinc-500 mb-1.5">
        {label}
      </div>
      <pre
        className={cn(
